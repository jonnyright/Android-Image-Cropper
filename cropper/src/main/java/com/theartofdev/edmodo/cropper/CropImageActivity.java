...
public class CropImageActivity extends AppCompatActivity
    ...
    /**
     * persist the flag if storage permission should be called automatically
     */
    private boolean requestStoragePermissions = true;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions = bundle.getBoolean(CropImage.CROP_IMAGE_EXTRA__REQUEST_STORAGE_PERMISSIONS);
        ...
        if (savedInstanceState == null) {
            ...
            } else if (requestStoragePermissions && CropImage.isReadExternalStoragePermissionsRequired(this, mCropImageUri)) {
                // request permissions and handle the result in onRequestPermissionsResult()
                requestPermissions(
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                // storage.
                if (requestStoragePermissions && CropImage.isReadExternalStoragePermissionsRequired(this, mCropImageUri)) {
                    // request permissions and handle the result in onRequestPermissionsResult()
                    requestPermissions(
                            new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
                            CropImage.PICK_IMAGE_PERMISSIONS_REQUEST_CODE);
